...
#include "Assets/Shader/Includes/UnityStandardInput.cginc"
...
#include "Assets/Shader/Includes/WorldCurved_Func.cginc"
...
struct VertexOutputForwardBase
{
    ...
    CURVEDWORLD_RANGE_FADE_COORDINATE(9)
};
...
half4 fragForwardBaseInternal (VertexOutputForwardBase i)
{
    ...
    //Curved World Range Fade
    #if defined(_ALPHABLEND_ON) || defined(_ALPHAPREMULTIPLY_ON)
        c *= 1 - CURVEDWORLD_RANGE_FADE_VALUE;
        s.alpha *= 1 - CURVEDWORLD_RANGE_FADE_VALUE;
    #endif
...
struct VertexOutputDeferred
{
    ...
    CURVEDWORLD_RANGE_FADE_COORDINATE(7)
};
