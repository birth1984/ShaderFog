...
#if !defined(V2F_SHADOW_CASTER_NOPOS_IS_EMPTY) || defined(UNITY_STANDARD_USE_SHADOW_UVS) || defined(V_CW_RANGE_FADE)
...
) : SV_Target
{
        ...
        CURVEDWORLD_RANGE_FADE_CALCULATE(i)
            ...
            clip (alpha - _Cutoff - CURVEDWORLD_RANGE_FADE_VALUE);
                ...
                clip (alphaRef - 0.01 - CURVEDWORLD_RANGE_FADE_VALUE);
            #else
                clip (alpha - _Cutoff - CURVEDWORLD_RANGE_FADE_VALUE);
            #endif
        #endif
